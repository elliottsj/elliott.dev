...
import puttygen01 from '../../public/images/puttygen01.png'

<Image src={puttygen01} alt="PuTTYgen" />
...
import puttygen02 from '../../public/images/puttygen02.png';

<Image src={puttygen02} alt="PuTTYgen" />
...
import puttygen03 from '../../public/images/puttygen03.png';

<Image src={puttygen03} alt="PuTTYgen" />

Copy the entire string to your clipboard.

Connect to CDF in PuTTY using your password:

import putty01 from '../../public/images/putty01.png';

<Image src={putty01} alt="PuTTY" />
...
import putty02 from '../../public/images/putty02.png';

<Image src={putty02} alt="PuTTY" />

Set your private key in _Connection_ -> _SSH_ -> _Auth_:

import putty03 from '../../public/images/putty03.png';

<Image src={putty03} alt="PuTTY" />

Create a saved session:

import putty04 from '../../public/images/putty04.png';

<Image src={putty04} alt="PuTTY" />
