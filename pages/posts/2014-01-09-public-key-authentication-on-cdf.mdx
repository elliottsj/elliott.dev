...
<Image src="/images/puttygen01.png" alt="PuTTYgen" unsized />
...
<Image src="/images/puttygen02.png" alt="PuTTYgen" unsized />
...
<Image src="/images/puttygen03.png" alt="PuTTYgen" unsized />

Copy the entire string to your clipboard.

Connect to CDF in PuTTY using your password:

<Image src="/images/putty01.png" alt="PuTTY" unsized />
...
<Image src="/images/putty02.png" alt="PuTTY" unsized />

Set your private key in _Connection_ -> _SSH_ -> _Auth_:

<Image src="/images/putty03.png" alt="PuTTY" unsized />

Create a saved session:

<Image src="/images/putty04.png" alt="PuTTY" unsized />
